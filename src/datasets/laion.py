...
def get_csv_dataset(args, preprocess_fn, is_train, epoch=0):
    ...
    if args.supervised_label_key is not None:
...
def get_data(args, preprocess_fns, epoch=0):
    ...
    data["train_ft"] = get_dataset_fn(args.ft_data, args.dataset_type)(args, preprocess_train, is_train=True, epoch=epoch)

    # if args.train_dataset == 'ImageNet':
    #     data["train_ft"] = get_imagenet(args, preprocess_fns, "train")
